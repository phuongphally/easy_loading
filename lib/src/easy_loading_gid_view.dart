...
/// This is an extension of the GridView widget that uses the GridView.builder constructor.
class EasyLoadingGridView extends StatefulWidget {
  /// A callback that indicates if the collection associated with the GridView has more items that should be loaded
  ...
  _EasyLoadingGridViewState createState() {
    return _EasyLoadingGridViewState();
  }
}

class _EasyLoadingGridViewState extends State<EasyLoadingGridView> {
